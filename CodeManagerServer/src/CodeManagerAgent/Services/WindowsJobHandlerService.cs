...
namespace CodeManagerAgent.Services
{
    ...
    {
        // unit of work
        public WindowsJobHandlerService(JobDetails jobDetails, JobConfiguration jobConfiguration, IOptions<AgentConfiguration> agentConfiguration, CancellationToken cancellationToken)
